      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-100 animate-in slide-in-from-top duration-300">
          <div className="px-4 pt-2 pb-6 space-y-2">
            <Link
              to="/menu"
              className="block px-4 py-3 text-slate-600 font-medium rounded-xl hover:bg-slate-50"
            >
              Menu
            </Link>
            <Link
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  onClick={logout}
                  className="w-full text-left px-4 py-3 text-red-500 font-medium rounded-xl hover:bg-red-50"
                >
                  Déconnexion
                </button>
              </>
              ...
              <Link
                to="/auth"
                className="block px-4 py-3 bg-primary text-white text-center font-bold rounded-xl transition-all"
              >
                Connexion
              </Link>
            )}
