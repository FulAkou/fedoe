        ...
        <div className="w-full bg-white h-full shadow-2xl pointer-events-auto flex flex-col animate-in slide-in-from-right duration-300">
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-100">
            <h2 className="text-2xl font-black text-slate-900 flex items-center gap-2">
              <ShoppingBag className="w-6 h-6 stroke-current text-primary" />
              Panier
            </h2>
            <button
              onClick={closeCart}
              ...
              <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500">
                    Ajoutez quelques plats délicieux !
                  </p>
                </div>
                <Button
                  onClick={closeCart}
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                      ...
                      <div className="flex justify-between items-end">
                        ...
                        <div className="flex items-center bg-slate-50 rounded-lg p-1">
                          ...
                          >
                            <Minus className="w-3 h-3 stroke-current" />
                          </button>
                          ...
                          <button
                            ...
                            className="w-6 h-6 flex items-center justify-center hover:bg-white rounded shadow-sm text-slate-500"
                          >
                            <Plus className="w-3 h-3 stroke-current" />
                          </button>
                        </div>
                      </div>
                    </div>
          ...
          {items.length > 0 && (
            <div className="p-6 bg-slate-50 border-t border-slate-100 space-y-4">
              ...
              >
                Commander
                <ArrowRight className="ml-2 w-5 h-5 stroke-current" />
              </Button>
            </div>
          )}
        </div>
