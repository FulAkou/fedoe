        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
               ...
               <div className="text-sm font-medium text-slate-500">Commandes actives</div>
            </div>
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
               <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Clients</span>
               </div>
               <div className="text-3xl font-black text-slate-900">128</div>
               <div className="text-sm font-medium text-slate-500">Inscrits ce mois</div>
            </div>
             <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
               <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Revenus</span>
               </div>
               <div className="text-3xl font-black text-slate-900">12.5k FCFA</div>
               <div className="text-sm font-medium text-slate-500">+15% vs mois dernier</div>
            </div>
             <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
               <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Avis</span>
               </div>
               <div className="text-3xl font-black text-slate-900">4.8</div>
               <div className="text-sm font-medium text-slate-500">Note moyenne</div>
            </div>
          </div>
        );
      case 'users':
