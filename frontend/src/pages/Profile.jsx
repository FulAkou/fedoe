      ...
      <div className="space-y-4">
        {userOrders.length > 0 ? (
          userOrders.map((order) => (
            <div
              key={order.id}
              className="bg-white dark:bg-slate-800 border dark:border-slate-700 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow"
            >
              <div className="flex flex-col md:flex-row justify-between md:items-center mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-500 mt-1">
                    <Clock className="w-3.5 h-3.5 stroke-current" />
          ...
          <div className="text-center py-12 bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-dashed border-gray-300 dark:border-slate-700">
            <Package className="w-12 h-12 stroke-current mx-auto text-gray-300 mb-4" />
